...
from telegrambot.services.services import save_data_to_cache, send_saved_message_text, get_user_lang
...
def set_birth_month(bot: Bot, update: Update):
    ...
    save_data_to_cache(external_id=update.effective_chat.id, data=month_of_birth, request_name='month_of_birth')
